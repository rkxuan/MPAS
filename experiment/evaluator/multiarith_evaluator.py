...
from experiment.evaluator.datasets.multiarith_dataset import multiarith_get_predict, record_to_system_input
...
class Evaluator():
    ...
    async def evaluate_direct_answer(self,
        ...
        print("Evaluating DirectAnswer on multiarith split val")

        math_agent = MathSolver("multiarith", self._model_name)
        ...
        for i_question, record in enumerate(dataset):
            ...
            answer = multiarith_get_predict(answers)
    ...
    async def evaluate_system(
        ...
        print(f"Evaluating system on multiarith split val")
    ...
    async def optimize_system(
        ...
        print(f"Optimizing system on multiarith split train")
