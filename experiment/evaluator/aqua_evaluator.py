...
from experiment.evaluator.datasets.aqua_dataset import aqua_get_predict, record_to_system_input
...
class Evaluator():
    ...
    async def evaluate_direct_answer(self,
        ...
        print("Evaluating DirectAnswer on aqua split val")

        math_agent = MathSolver("aqua", self._model_name)
        ...
        for i_question, record in enumerate(dataset):
            ...
            answer = aqua_get_predict(answers)
    ...
    async def evaluate_system(
        ...
        print(f"Evaluating system on aqua split val")
    ...
    async def optimize_system(
        ...
        print(f"Optimizing system on aqua split train")
