...
@OperationRegistry.register("DirectAnswer")
class DirectAnswer(Operation):
    def __init__(self, domain: str,
                 model_name: Optional[str] = None,
                 operation_description: str = "Analyze the given question",
                 ):
    ...
    async def _execute(self, raw_inputs: Message,
        ...
        constraint = self.prompt_set.get_thought_constraint()
        prompt = self.prompt_set.get_message_prompt(raw_inputs=raw_inputs, messages=messages, self_messages=self_messages)
